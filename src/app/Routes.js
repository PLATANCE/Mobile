        ...
        return (
            <Provider store={store}>
                <Router hideNavBar={true}>
                    <Route name="DailyMenuPage" component={connect(DailyMenuSelector)(DailyMenuPage)} title="DailyMenu"/>
                    <Route name="MenuDetailPage" component={connect(MenuDetailSelector)(MenuDetailPage)} initial={true} wrapRouter={true} title="MenuDetailPage"/>
                </Router>
            </Provider>
        );
    }
